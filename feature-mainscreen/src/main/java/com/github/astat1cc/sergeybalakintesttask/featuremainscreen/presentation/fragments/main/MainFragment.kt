package com.github.astat1cc.sergeybalakintesttask.featuremainscreen.presentation.fragments.main
...
import com.github.astat1cc.sergeybalakintesttask.featuremainscreen.presentation.fragments.main.utils.FilterCategory
...
class MainFragment : Fragment() {
    ...
    private fun setOnClickListeners() {
        with(binding) {
            ...
            locationContainer.setOnClickListener { openMap() }
        }
    }

    private fun openMap() {
        findNavController().navigate(AppRoutes.MapScreen.Entry)
    }
